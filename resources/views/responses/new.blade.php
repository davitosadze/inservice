    ...
    <section class="content">
        ...
        <div class="response-tabs-container">
            <div class="response-tabs">
                <a class="response-tab" href="{{ route('responses.index', ['type' => 'pending']) }}">
                    <i class="fas fa-bolt"></i>
                    <span>მთავარი რეაგირებები</span>
                </a>
                <a class="response-tab" href="{{ route('responses.index', ['type' => 'client-pending']) }}">
                    <i class="fas fa-clock"></i>
                    <span>კლიენტის მოლოდინში</span>
                </a>
                <a class="response-tab active" href="{{ route('responses.new') }}">
