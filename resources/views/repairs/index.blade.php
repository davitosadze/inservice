    ...
    <section class="content">
        ...
        <div class="service-tabs-container">
            <div class="service-tabs">
                <a class="service-tab {{ request()->get('type') == 'pending' || !request()->get('type') ? 'active' : '' }}" href="{{ route('repairs.index', ['type' => 'pending']) }}">
                    <i class="fas fa-tools"></i>
                    <span>მთავარი რემონტები</span>
                </a>
                <a class="service-tab {{ request()->get('type') == 'standby' ? 'active' : '' }}" href="{{ route('repairs.index', ['type' => 'standby']) }}">
                    <i class="fas fa-clock"></i>
                    <span>მოლოდინის რეჟიმი</span>
                </a>
                <a class="service-tab {{ request()->get('type') == 'client-pending' ? 'active' : '' }}" href="{{ route('repairs.index', ['type' => 'client-pending']) }}">
                    <i class="fas fa-user-clock"></i>
                    <span>კლიენტის მოლოდინი</span>
                </a>
                <a class="service-tab" href="{{ route('repairs.new') }}">
