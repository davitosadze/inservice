        ...
        <div id="company" style="width:45%; border: 1px solid #fff;">
            ...
            <div style="padding: 0 0.5em" class="clearfix">
                ...
                <div style="float:right; width: 77%;">
                    ...
                    <div><b>ანგ.</b> # GE94 BG00 0000 0609 8583 91</div>
                    <div><b>ანგ.</b> # GE75 CD03 6000 0057 2676 23</div>
                </div>
                ...
                @foreach ($model['category_attributes'] as $key => $item)
                    <tr>
                        ...
                        <td style="text-align:right;"class="unit">
                            {{ number_format($item['pivot']['evaluation_price'], 2, '.', '') }}</td>
                        <td style="text-align:right"class="unit">
                            {{ number_format($item['pivot']['evaluation_service_price'], 2, '.', '') }}</td>
                        <td style="text-align:center" class="total">
                            {{ number_format($item['pivot']['evaluation_calc'], 2, '.', '') }} ლ</td>
                    </tr>
                @endforeach
