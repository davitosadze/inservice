...
<x-app-layout>
    ...
    <x-slot name="header">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">რემონტის მოწყობილობა</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
    ...
    <section class="content">
        {{ Form::model($model, ['route' => ['repair-devices.store', $model->id], 'id' => 'render']) }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
                            ...
                            <div class="form-group">
                                <label for="formGroupExampleInput">ლოკაციის სახელი</label>
                                {{ Form::text('name', $model->name, ['placeholder' => 'ლოკაციის სახელი', 'class' => 'form-control']) }}
