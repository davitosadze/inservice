@section('title', 'მოწყობილობის სახეობები')
<x-app-layout>
    ...
    <x-slot name="header">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">მოწყობილობის სახეობა</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
    ...
    <section class="content">
        {{ Form::model($model, ['route' => ['device-types.store', $model->id], 'id' => 'render']) }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
                            ...
                            <div class="form-group">
                                <label for="formGroupExampleInput">მოწყობილობის სახეობის სახელი</label>
                                {{ Form::text('name', $model->name, ['placeholder' => 'მოწყობილობის სახეობის სახელი', 'class' => 'form-control']) }}
