...
<x-app-layout>
    ...
    <section class="content">
        {{ Form::model($model, ['route' => ['performers.store', $model->id], 'id' => 'render']) }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
                            ...
                            <div class="form-group">
                                <label for="formGroupExampleInput">შემსრულებლის სახელი</label>
                                {{ Form::text('name', $model->name, ['placeholder' => 'შემსრულებლის სახელი', 'class' => 'form-control']) }}
