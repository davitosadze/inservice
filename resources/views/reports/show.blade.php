...
<body>
    ...
    <main>
        ...
        <div style="padding:0.5cm;">
            ...
            <center>
                <h4 style="padding:0; margin: 0;" class="h4 text-center">აქტი: {{ $model['uuid'] }}</h4>
            </center>
            ...
            <div class="d-flex flex-column-reverse align-items-end" style="float: right;">
                ...
                <div class="row">
                    <div class="col" style="color: #5c5449;"><b>თარიღი :
                            {{ date_format(date_create($model['created_at']), 'Y-m-d') }}</b></div>
                </div>
            </div>
                                        ...
                                        @foreach ($nestedItem['media']->chunk(2) as $chunk)
                                            <tr style="margin-top: 0.1cm; border: 2px solod #000000;">
                                                ...
                                                @foreach ($chunk as $chunkIndex => $product)
                                                    <td width="width: 50" valign="center"
                                                        class="{{ $chunkIndex % 2 == 0 ? 'right' : 'left' }}"
            ...
            <div>
                ...
                <div>
                    <table style="width:100%; padding: 0; color: #5c5449;">
                        <thead>
                            <tr>
                                <td valign="center" style="width:33.33%  padding: 0; vertical-align: middle;">ტექნიკური
                                    მენეჯერი</td>
                                <td valign="center"
                                    style="width:33.33%; padding: 0; vertical-align: middle; border-bottom: 1px solid #000; text-align: center;">
                                    <img style="max-width: 55%;"
                                        src="{{ $model->user->getFirstMediaUrl('credential') }}">
                                </td>
                                <td valign="center"
                                    style="width:33.33%; padding: 0; vertical-align: middle; text-align: right;">
                                    {{ $model->user->name }}</td>
                            </tr>
                        </thead>
                    </table>
