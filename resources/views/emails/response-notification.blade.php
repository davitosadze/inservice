...
<body>
    <div class="email-container">
        ...
        <div class="content">
            @if($status === 'new')
                <h2 class="section-title">შეკვეთა #QR{{ $id }} მიღებულია</h2>
                
                <div class="info-line">
                    <span class="label">სახელი:</span>
                    <span class="value">{{ $response?->user?->name }}</span>
                </div>
                ...
                <div class="info-line">
                    ...
                    <span class="value">{{ $response?->subject_name }}</span>
                </div>
                
                <div class="info-line">
                    <span class="label">მისამართი:</span>
                    <span class="value">{{ $response?->subject_address }}</span>
                </div>
            ...
            @elseif($status === 'completed')
                <h2 class="section-title">თქვენი შეკვეთა #QR{{ $id }} დასრულებულია</h2>
                ...
                <div class="info-line">
                    ...
                    <span class="value">{{ $response?->created_at }}</span>
                </div>
                ...
                <div class="info-line">
                    ...
                    <span class="value">{{ $response?->end_time }}</span>
                </div>
                
                <div class="info-line">
                    <span class="label">სამუშაოს აღწერა:</span>
                    <span class="value">{{ $response?->job_description }}</span>
                </div>
