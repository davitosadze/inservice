    ...
    <section class="content">
        ...
        <div class="service-tabs-container">
            <div class="service-tabs">
                <a class="service-tab" href="{{ route('services.index', ['type' => 'pending']) }}">
                    <i class="fas fa-tools"></i>
                    <span>მიმდინარე სერვისები</span>
                </a>
                <a class="service-tab active" href="{{ route('services.new') }}">
                    <i class="fas fa-check-circle"></i>
                    <span>დასრულებული გეგმიური სამუშაოები</span>
                </a>
            </div>
        </div>
