                    ...
                    <div class="tab-content" id="custom-tabs-three-tabContent">
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                :class="{
                                    'is-invalid':
                                        v$.m.description.$errors.length,
                                }"
                                v-model="v$.m.description.$model"
                                class="form-control"
                            ...
                            <div
                                class="invalid-feedback"
                                v-if="!v$.m.description.required.$response"
                            >
                                ჩაწერეთ კატეგორიის აღწერა!
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input
                                :class="{
                                    'is-invalid': v$.m.type.$errors.length,
                                }"
                                v-model="v$.m.type.$model"
                                type="text"
                                class="form-control"
                                id="formGroupExampleInput"
                                placeholder=""
                            ...
                            <div
                                class="invalid-feedback"
                                v-if="!v$.m.type.required.$response"
                            >
                                ჩაწერეთ ერთეულის დასხელება!
                            </div>
                        </div>
    ...
    computed: {
        attrsLink() {
            return this.setting.url.nested.attributes
                .replace("api/", "")
                .replace("__category__", this.model.id);
        },
        category() {
